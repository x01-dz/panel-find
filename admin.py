...
+=================================================+
''')
print(" \033[95m You Must Write Protcole HTTPS:// or HTTP:// ex: http://www.ex.com , ex :https://www.ex.com ")
...
'memberadmin/','administratorlogin/','adm/','account.asp','ebrigade/','admin/account.asp','admin/index.asp','admin/login.asp','admin/admin.asp','/login.aspx',
...
print ("----------------------------------------------------------------------------------------")
print ("\033[93m     i HOPE I HAVE HELPED YOU ^_^ , TY FOR USE MY SCRIPT -x01-Dz-")
print ("----------------------------------------------------------------------------------------")
